...
def main():
    ...
    parser.add_argument('--metalogs', default='/root/autodl-tmp/metalogs_fc100')
    parser.add_argument('--output', default='compare_shadow_raw_fc100.png')
    ...
    patterns = {
        'pzobo': os.path.join(base, 'pzobo_fc100_run{i}.pt'),
        'qnbo': os.path.join(base, 'qNBO_fc100_run{i}.pt'),
        'f2ba': os.path.join(base, 'F2BA_shots5_fc100_T30_run{i}.pt'),
        'ifsba': os.path.join(base, 'IFSBA_fc100_run{i}.pt'),
    }
